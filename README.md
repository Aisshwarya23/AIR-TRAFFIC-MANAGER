...
Airplane Management System – EMU8086
...
Flight Management
Add flight details, calculate travel duration, and compute arrival times.

Air Traffic Control (ATC)
Simulates runway access, landing permissions, and simple conflict detection.

Fuel Monitoring
Displays current fuel levels and shows alerts when fuel is low.

Graphical ASCII Output
Aircraft, runway, and radar visuals created using character-based graphics.
...
Structured modular design in 8086

Aviation domain problem-solving in a resource-limited environment
